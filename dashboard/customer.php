...
<body id="page-top" class="bg-orange-light">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-orange-dark">Data Customer yang membeli Produk</h1>
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-orange-dark">
                                                ...
                                                <?php  
                                                 ...
                                                 $sql = "SELECT COUNT(customerID) as jumlah_customer from customer";
                                                     $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo number_format($row2['jumlah_customer'],0,".",".");
                                                        }
                                                ?>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-orange-dark">
                                                ...
                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(f.customerID)) customer FROM fact_sales f JOIN time d ON f.dateID=d.dateID WHERE d.Tahun=2001";
                                                $query = mysqli_query($mysqli,$sql);
                                                    while($row2=mysqli_fetch_array($query)){
                            ...
                            <div class="card border-left-orange-dark shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Customer Tahun 2002</div>
                                            <div class="h5 mb-0 font-weight-bold text-orange-dark">

                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(f.customerID)) customer FROM fact_sales f JOIN time d ON f.dateID=d.dateID WHERE d.Tahun=2002";
                                                $query = mysqli_query($mysqli,$sql);
                                                    while($row2=mysqli_fetch_array($query)){
                                                        echo number_format($row2['customer'],0,".",".");
                                                    }
                            ...
                            <div class="card border-left-orange-dark shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Customer Tahun 2003</div>
                                            <div class="h5 mb-0 font-weight-bold text-orange-dark">

                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(f.customerID)) customer FROM fact_sales f JOIN time d ON f.dateID=d.dateID WHERE d.Tahun=2003";
                                                $query = mysqli_query($mysqli,$sql);
                                                    while($row2=mysqli_fetch_array($query)){
                                                        echo number_format($row2['customer'],0,".",".");
                                                    }
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-orange-dark">
                                                ...
                                                <?php
                                                $sql = "SELECT COUNT(DISTINCT(f.customerID)) customer FROM fact_sales f JOIN time d ON f.dateID=d.dateID WHERE d.Tahun=2004";
                                                $query = mysqli_query($mysqli,$sql);
                                                    while($row2=mysqli_fetch_array($query)){
                                                        echo number_format($row2['customer'],0,".",".");
                                                    }
    ...
    <script type="text/javascript">
        ...
        <?php
            ...
            $customer = "SELECT COUNT(DISTINCT(f.customerID)) customer FROM fact_sales f JOIN time d ON f.dateID=d.dateID GROUP BY d.bulan ORDER BY d.dateID";
            $i=1;
