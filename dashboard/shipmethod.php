        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-orange-dark">Data Metode Pengiriman Produk</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div
                                ...
                                <h6 class="m-0 font-weight-bold text-orange-dark">Kategori Metode Pengiriman Terbanyak</h6>
                            </div>
                            <!-- Card Body -->
                                ...
                                <div class="chart-area-store">
                                    ...
                                    <!-- <canvas id="myAreaChart"></canvas> -->
                                        <?php
                                            ...
                                            $database   = "dwo";
                                            $mysqli     = mysqli_connect($host, $user, $password, $database);
                                            $pengiriman = mysqli_query($mysqli,"SELECT DISTINCT(shipper_name), COUNT(fs.customerID) as total FROM fact_sales fs JOIN shipper s ON fs.shipperID = s.shipperID GROUP BY s.shipper_name ORDER BY total DESC");
                                            while($row = mysqli_fetch_array($pengiriman)){
                                                $jenis_pengiriman[] = $row['shipper_name'];

                                                $query = mysqli_query($mysqli,"SELECT COUNT(fs.customerID) as total FROM fact_sales fs JOIN shipper s ON fs.shipperID = s.shipperID WHERE s.shipper_name='".$row['shipper_name']."'");
